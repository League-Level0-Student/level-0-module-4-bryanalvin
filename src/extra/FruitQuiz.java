...
public class FruitQuiz extends KeyAdapter {
	...
	question1 = new JLabel("<html>Which is not a real fruit? <br> A: Dragon Fruit <br> B: Durian <br> C: Crazyberry</html>");
		...
		question2 = new JLabel("<html>Which is  a real fruit? <br> A: Goyum Berry <br> B: Orange <br> C: Digimelon</html>");
		
		question3 = new JLabel("<html>Which is of te following is a great source of  <br> A: Goyum Berry <br> B: Orange <br> C: Digimelon</html>");
