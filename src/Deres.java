...
if(dead.equals("Kiss a girl and start a fight")) {
	JOptionPane.showMessageDialog(null, "He kisses one of the girls with passion and the girls start fighting for the boy and him and his companions walked away it seems Chiaki was very triggered from that");
}
	
if(dead.equals("Slice them to peices and your companions run away from you")) {
	JOptionPane.showMessageDialog(null, "The boy held his sword and sliced all the girls into little peices in one go all of his companions saw him and left the boy alone to find new companions");	
	}
