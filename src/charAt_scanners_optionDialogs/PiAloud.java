...
public static void main(String[] args) {
	...
	String Pie="3.14159265358979323846264338327950288419716939937510582097494459230781640628620899862803482534211706798214808651328230664709384460955058223172535";
	// 3. Print out some digits of Pi. The first value is "pi.charAt(0)", the second is "pi.charAt(1)
	System.out.println(Pie.charAt(0)+"  "+Pie.charAt(1));
